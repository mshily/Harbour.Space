...
class DeleteActivityActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Log.d("DeleteActivityActivity", "onCreate")
...
@Composable
fun DeleteActivityActivityScreen (
    ...
    Column(
        ...
        Text(
            text = "print name of a deleting activity",
        ...
        Button(
            onClick = {
                if (name.isNotBlank()) {
                    Log.d("DeleteActivityActivityScreen", "onClick")
                    viewModel.deleteActivityByName(name)
                    onBack()
                }
            },
            modifier = Modifier
