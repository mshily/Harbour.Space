...
import com.vina_esima.final_project.UnsplashApi
...
private val retrofit: UnsplashApi by lazy {
...
class UnsplashApiProvider() {
    fun fetchImages(cb: UnsplashViewModel) {
    ...
    fun searchImages(cb: UnsplashViewModel, query: String) {
